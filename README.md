...
* If using Cloud9: Click on the _gear_ icon at the top left above the project folders and select "Show Hidden Files."
* If using Codenvy: Click on the "Projects" menu and select "Show/Hide Hidden Files".
* Open the `.gitignore` file
* At the bottom of the `.gitignore` file, make a new blank line by hitting Enter and then type `.*`
* Then, delete lines 26 and 27 which contain `bower_components`
